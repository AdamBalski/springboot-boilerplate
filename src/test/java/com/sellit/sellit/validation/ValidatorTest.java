...
class ValidatorTest {
    ...
    void testReturnsSuccessAndReturnsFailure() {
        ...
        Assertions.assertEquals(com.sellit.sellit.validation.ValidationResultImpl.FAILURE, ValidationResultImpl);
    }
    ...
    void testReturnsSuccessAndReturnsSuccess() {
        ...
        Assertions.assertEquals(com.sellit.sellit.validation.ValidationResultImpl.SUCCESS, ValidationResultImpl);
    }
